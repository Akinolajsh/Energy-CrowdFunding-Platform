      ...
      >
        ...
        <div className="flex flex-col justify-center items-center ">
          ...
          <div className="text-[13px] text-center text-slate-400">
            Elevate your experience with us - registering not only provides you
            with personalized content and exclusive offers but also grants you a
            secure and convenient access to our community. Take the first step
            towards an enhanced journey with us by signing up today.
          </div>
        </div>
