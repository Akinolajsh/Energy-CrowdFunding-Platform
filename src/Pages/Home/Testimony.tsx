const Testimony = () => {
  return (
    <div>
      <div className="w-full h-[auto]  p-6 pl-4 flex justify-between small:flex-col ">
      ...
      <div className="bg-yellow-00 w-[64%] h-full  flex-wrap small:full meduim:justify-center">
        <div className="w-[780px] h-[520px]  mx-[30px] flex flex-wrap small:w-[620px]  relative ">
          <div className="w-[330px] h-[290px] border absolute bottom-12 left-[220px] bg-slate-100 -z-30 small:hidden"></div>
